...
class Routine(object):
    ...
    def definitions(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.moveTo("r_elbow_flex_joint", 40)
            self.moveTo("l_elbow_flex_joint", 60)
            sleep(6)
            ...
            ## bicep
            self.moveTo("r_elbow_flex_joint", 100)
            self.moveTo("l_elbow_flex_joint", 100)
            sleep(3)

            # rotate extended
            self.moveTo("l_upper_arm_roll_joint", 120)
            self.moveTo("r_upper_arm_roll_joint", 90)
            sleep(5)

            # rotate front
            self.moveTo("l_upper_arm_roll_joint", 90)
            self.moveTo("r_upper_arm_roll_joint", 55)
            sleep(3)

            # shoulder
            self.moveTo("l_shoulder_lift_joint", 100)
            self.moveTo("r_shoulder_lift_joint", 70)
            sleep(6)
            ...
            # shoulder down
            self.moveTo("l_shoulder_lift_joint", 30)
            self.moveTo("r_shoulder_lift_joint", 0)
            sleep(4)

            # omoplate
            self.moveTo("l_shoulder_out_joint", 135)
            self.moveTo("r_shoulder_out_joint", 135)
            sleep(5)
