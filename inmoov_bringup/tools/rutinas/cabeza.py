    ...
    def definitions(self):
        ...
        while not rospy.is_shutdown():
            ...
            for i in range (100, 150):
                self.moveTo("head_pan_joint",i)  #movimiento suave de cuello
                sleep(0.1)
            
            for i in range (150, 50, -1):
                self.moveTo("head_pan_joint",i) 
                sleep(0.1)    
            ...
            self.moveTo("head_tilt_joint",20)   
            sleep(1)
            self.moveTo("head_tilt_joint",60)
            sleep(1)
            ...
            self.moveTo("head_tilt_joint",100)  
            sleep(1)
